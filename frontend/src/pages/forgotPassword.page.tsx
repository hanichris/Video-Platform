...
const forgotPasswordModel = object({
  email: string()
    .min(1, "Email address is required")
    .email("Email Address is invalid"),
});

export type forgotPasswordInput = TypeOf<typeof forgotPasswordModel>;
...
const forgotPasswordPage = () => {
  ...
  const createUserPassword = async (data: forgotPasswordInput) => {
    try {
